...
module.exports = async (req,res) => {
    ...
    if(!req.params['boardId'] || !req.body['category_id'] || !req.body['title'] || !req.body['content']){
    ...
    try {
        ...
        const whereSql = pool.format(setsql,{CATEGORY_ID:Number(category_id),TITLE:title,CONTENT:content});
